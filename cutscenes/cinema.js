function cTitre(){
    ...
    var ff = function(t) {
        ...
        if (imgCinema[1] == "go"){ 
            ...
            cGlobalCine = [[1,"ocean",35,29,35,17,"jour"],[100,"particle","bla",35,26,1,0,0,-1,["Bonjour et bienvenue dans cette première démo de Cavalcade. Pour passer une boîte de dialogue, appuyez sur espace.","Les flèches servent à déplacer le personnage principal. Si vous avez besoin de redefinir les touches ou de les connaître, appuyez sur a.","Appuyer maintenant ne servira à rien bande de gredins ! Il faut attendre que la cinématique soit finie.","Cette démo ne contient pas de scénario mais juste la première zone du jeu sans aucun contexte pour éviter les spoilers.","Cette démo sert surtout de test. Reportez les bugs si vous le voulez bien et amusez vous."]],[60,"unFreeze"]];
            cinematicos = 11;
            animation();
        }
